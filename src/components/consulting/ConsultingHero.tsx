...
const STATS = [
  ...
  { value: "₹50Cr+", label: "Infrastructure Planned" },
...
export function ConsultingHero() {
  return (
    <section className="relative min-h-[85vh] overflow-hidden bg-[#050d18]">
      ...
      {/* Animated aurora blobs — orange + electric-blue */}
      <motion.div
        className="pointer-events-none absolute left-1/4 top-0 size-[700px] rounded-full bg-orange/10 blur-[150px]"
        animate={{
          x: [0, 80, -40, 0],
          y: [0, -60, 40, 0],
          scale: [1, 1.15, 0.95, 1],
      ...
      />
      <motion.div
        className="pointer-events-none absolute left-0 top-1/2 size-[350px] rounded-full bg-orange/5 blur-[100px]"
        animate={{
          x: [0, 60, -30, 0],
          y: [0, -50, 30, 0],
        }}
      ...
      <div className="relative z-10 mx-auto flex max-w-7xl flex-col items-center justify-center px-6 py-32 text-center lg:min-h-[85vh] lg:px-8 lg:py-0">
        ...
        >
          <span className="inline-flex items-center gap-2 rounded-full border border-white/[0.08] bg-white/[0.04] px-4 py-1.5 text-sm text-white/70 backdrop-blur-sm">
            <span className="flex size-5 items-center justify-center rounded-full bg-orange/20">
              <Lightbulb className="size-3 text-orange" />
            </span>
            Expert Consulting
          </span>
        </motion.div>
        ...
        <div className="mt-8">
          <AnimatedHeadline
            text="Navigate your EV charging"
          ...
          >
            <motion.span
              ...
              className="inline-block bg-gradient-to-r from-orange via-[#FBBF24] to-orange bg-clip-text text-transparent"
            >
        ...
        >
          From free self-serve tools to enterprise-grade planning — choose the
          level of support that matches your ambition.
        </motion.p>
        ...
        >
          <Button
            asChild
            size="lg"
            className="bg-orange px-6 font-semibold text-white shadow-[0_0_30px_rgba(255,107,53,0.25)] transition-shadow hover:bg-orange/90 hover:shadow-[0_0_50px_rgba(255,107,53,0.4)]"
          >
