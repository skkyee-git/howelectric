...
// ── Product Card with Tilt + Light Reflection ─────────────────────────
...
function ProductCard({
  ...
  return (
    <motion.div
      className="w-[320px] shrink-0 lg:w-[340px]"
    ...
    >
      ...
      >
        ...
        {/* Image area */}
        <div
          className={`relative flex h-52 items-center justify-center bg-gradient-to-br ${product.gradient}`}
        >
          {/* Product icon */}
          <motion.div
...
export function FeaturedProducts() {
  ...
  return (
    <section ref={containerRef} className="overflow-hidden bg-light-gray py-24 lg:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="flex items-end justify-between gap-8">
          <ScrollReveal>
            ...
            <h2 className="mt-3 max-w-lg">Featured chargers</h2>
            <p className="mt-3 max-w-xl text-base text-muted-foreground">
              Hand-picked from 50+ brands. Every charger tested, verified, and
              ready to deploy.
            </p>
          </ScrollReveal>
      ...
      <div className="mt-12">
        <motion.div style={{ x }} className="flex gap-5 px-6 lg:px-8">
